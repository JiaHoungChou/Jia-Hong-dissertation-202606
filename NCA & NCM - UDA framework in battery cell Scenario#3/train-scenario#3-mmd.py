...
if __name__== "__main__":
    ...
    SOURCE_DOMAIN= "ncm-45"; TARGET_DOMAIN= "nca-45"
    SOURCE_CELLS= ["NCM cell#14", "NCM cell#08", "NCM cell#13", "NCM cell#26", "NCM cell#25", "NCM cell#20", "NCM cell#21", "NCM cell#12"]
    SOURCE_CELLS= [cell.split(" ")[0]+ " "+ "Cell%2d"%(int(cell.split("#")[-1])) for cell in SOURCE_CELLS]
    TARGET_CELLS= ["NCA cell#11", "NCA cell#23", "NCA cell#26"]
