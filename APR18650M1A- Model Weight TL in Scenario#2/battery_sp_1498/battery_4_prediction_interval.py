...
if __name__== "__main__":
    ...
    mdoel_weight_saving_path=  r"C:\Users\USER\Desktop\battery_sp_3"

    file_path= r"C:\Users\USER\Desktop\battery_sp_3\Battery_3-_4.csv"
    ...
    ############### RUL prediction ###############
    model_libaray= r"C:\Users\USER\Desktop\battery_sp_3\model_check_point"
    ...
    selected_param= {"seq_len": 16, "hidden_size": 107, "batch_size": 74}
    ...
    plt.scatter(Training_Cycle_Index[1], y_data[Training_Cycle_Index[1]], label= "Sp (#1498)", color= "black", s= 100, marker= "o")
