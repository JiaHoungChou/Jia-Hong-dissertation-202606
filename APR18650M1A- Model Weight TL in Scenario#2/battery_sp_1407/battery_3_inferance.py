...
if __name__== "__main__":
    ...
    mdoel_weight_saving_path=  r"C:\Users\MA201-01\Desktop\Group2\battery_sp_1\battery_sp_1882"
    ...
    Training_Cycle_Index= [knee_onset_double_bacon_watts, sp+ 1]
    Testing_Cycle_Index=  [sp+ 1+ 1, -1]
    ...
    plt.xlim(0, np.max([actual_eol, pred_eol]))
