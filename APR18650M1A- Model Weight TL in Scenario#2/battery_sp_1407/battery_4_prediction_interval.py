...
if __name__== "__main__":
    ...
    mdoel_weight_saving_path=  r"C:\Users\MA201-01\Desktop\Group2\battery_sp_1"

    file_path= r"C:\Users\MA201-01\Desktop\Group2\battery_sp_1\Battery_3-_4.csv"
    ...
    ############### RUL prediction ###############
    model_libaray= r"C:\Users\MA201-01\Desktop\Group2\battery_sp_1\model_check_point"
    ...
    selected_param= {"seq_len": 21, "hidden_size": 115, "batch_size": 113}
    ...
    plt.plot(np.arange(0, Training_Cycle_Index[1]), y_data[: Training_Cycle_Index[1]], label= "actual battery #4 (known)", color= "black")
    plt.plot(np.arange(Testing_Cycle_Index[0]+ 1, len(y_data)), test_y, label= "actual battery #4 (unknown)", color= "blue")
    ...
    plt.scatter(Training_Cycle_Index[1], y_data[Training_Cycle_Index[1]], label= "Sp (#1407)", color= "black", s= 100, marker= "o")
