...
if __name__== "__main__":
    ...
    model_libaray= r"C:\Users\USER\Desktop\battery_sp_2\model_check_point_2"
    ...
    for index in range(0, len(DL_model_check_point_list)):
        ...
        plt.plot(pred_cycle, composed_SOH, label= "SOH online prediction", color= "orange")
        plt.xlim(Testing_Cycle_Index[0], np.max(est_eol))
        plt.legend(loc= "best")
        plt.show()
