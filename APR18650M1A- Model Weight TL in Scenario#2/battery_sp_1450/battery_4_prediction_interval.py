...
if __name__== "__main__":
    ...
    for i in range(0, len(rul_prediction_storage)):
        if i== 0:
            plt.plot(np.arange(Testing_Cycle_Index[0]+ 1, Testing_Cycle_Index[0]+ 1+ len(rul_prediction_storage[i])), rul_prediction_storage[i], label= "prediction uncertainty", color= "red", alpha= 0.3)
        else:
    ...
    plt.scatter(Training_Cycle_Index[1], y_data[Training_Cycle_Index[1]], label= "Sp (#1450)", color= "black", s= 100, marker= "o")
