...
if __name__== "__main__":
    ...
    mdoel_weight_saving_path=  r"C:\Users\MA201-01\Desktop\Group1\battery_sp_2047"

    file_path= r"C:\Users\MA201-01\Desktop\Group1\battery_sp_2047\Battery_1-_2.csv"
    ...
    Training_Cycle_Index= [knee_onset_double_bacon_watts, 2047]
    Testing_Cycle_Index=  [2047+ 1, -1]
    ...
    ############### RUL prediction ###############
    model_libaray= r"C:\Users\MA201-01\Desktop\Group1\battery_sp_2047\model_check_point"
    ...
    selected_param= {"seq_len": 31, "hidden_size": 103, "batch_size": 11}
    ...
    plt.scatter(Training_Cycle_Index[1], y_data[Training_Cycle_Index[1]], label= "Sp (#2048)", color= "black", s= 100, marker= "o")
