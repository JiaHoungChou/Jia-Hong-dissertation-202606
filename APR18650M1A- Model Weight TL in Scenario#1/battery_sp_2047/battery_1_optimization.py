...
class DL_optimization_process:
    ...
    def process(self, seq_len: int, hidden_size: int, batch_size: int, cycle: np.array, x: np.array, valid_y: np.array):
        ...
        if error <= 0.01:
            print("Hyperparm -> seq_len_%3d, hidden_size_%3d, batch_size_%3d"%(seq_len, hidden_size, batch_size))
            print("Bi-LSTM-AT online prediction error: ", error)
            
            dirName= os.path.join(saving_path, "residual_model_seq_len_%3d_hidden_size_%3d_batch_size_%3d"%(seq_len, hidden_size, batch_size))
...
if __name__== "__main__":
    ...
    plt.scatter(1881, y_data[1881], label= "Sp", color= "red", s= 200, marker= "o")
    ...
    Training_Cycle_Index= [knee_onset_double_bacon_watts, sp_param]
    Testing_Cycle_Index=  [sp_param+ 1, -1]
    ...
    saving_path= r"C:\Users\MA201-01\Desktop\Group1\battery_sp_2047"
    ...
    opt_Bi_LSTM_AT_model= DL_optimizer.run_optimization(param_bounds= [(12, 36), (90, 110), (10, 14)], max_iteration= 10, visualization= None)

    saving_path= r"C:\Users\MA201-01\Desktop\Group1\battery_sp_2047\model_check_point"
