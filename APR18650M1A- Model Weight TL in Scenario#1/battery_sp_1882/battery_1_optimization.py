...
class BI_LSTM_ATTENTION(nn.Module):
    ...
    def forward(self, x):
        ...
        ### Q: output of LSTM, K: hidden state, V: hidden state
...
if __name__== "__main__":
    ...
    file_path= os.path.join(os.getcwd(), "Battery_1-_2.csv")
    ...
    plt.plot(x_data, y_data, label= "SOH")
    ...
    Training_Cycle_Index= [knee_point, 1882]
    ...
    saving_path= r"C:\Users\MA201-01\Desktop\1.draft_paper\2.program\Group1\battery_sp_1882"
    ...
    saving_path= r"C:\Users\MA201-01\Desktop\1.draft_paper\2.program\Group1\battery_sp_1882\model_check_point"
