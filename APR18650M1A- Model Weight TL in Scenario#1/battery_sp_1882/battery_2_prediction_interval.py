...
if __name__== "__main__":
    ...
    mdoel_weight_saving_path=  r"C:\Users\MA201-01\Desktop\Group1\battery_sp_1882"

    file_path= r"C:\Users\MA201-01\Desktop\Group1\battery_sp_1882\Battery_1-_2.csv"
    ...
    Training_Cycle_Index= [knee_onset_double_bacon_watts, 1882]
    Testing_Cycle_Index=  [1882+ 1, -1]
    ...
    ############### RUL prediction ###############
    model_libaray= r"C:\Users\MA201-01\Desktop\Group1\battery_sp_1882\model_check_point"
    ...
    selected_param= {"seq_len": 34, "hidden_size": 95, "batch_size": 12}
    ...
    plt.scatter(Training_Cycle_Index[1], y_data[Training_Cycle_Index[1]], label= "Sp (#1883)", color= "black", s= 100, marker= "o")
